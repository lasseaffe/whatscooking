...
export default function DiscoverStep() {
  return (
    ...
    >
      ...
      >
        <Sparkles style={{ width: 40, height: 40, color: "var(--wc-pal-accent, #B07D56)" }} />
      </div>
      <div>
        <h2
        ...
        <p className="text-sm leading-relaxed mb-4" style={{ color: "#9A7A5A" }}>
          Swipe through recipes like a deck of cards — save the ones that catch your eye and skip the rest.
          The Discover page lets you filter by cuisine, dietary needs, prep time, and more.
          The more you interact, the better your suggestions get.
        </p>
      </div>
      <Link
        href="/swipe"
