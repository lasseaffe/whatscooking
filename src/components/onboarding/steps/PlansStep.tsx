...
export default function PlansStep() {
  return (
    ...
    >
      ...
      >
        <CalendarDays style={{ width: 40, height: 40, color: "var(--wc-pal-accent, #B07D56)" }} />
      </div>
      <div>
        <h2
        ...
        <p className="text-sm leading-relaxed mb-4" style={{ color: "#9A7A5A" }}>
          Create a meal plan from scratch or let AI generate one based on your dietary preferences, pantry, and budget.
          Each plan produces a ready-to-use shopping list and tracks your calorie goals automatically.
          Share plans with your household so everyone stays in sync.
        </p>
      </div>
      <Link
        href="/plans"
