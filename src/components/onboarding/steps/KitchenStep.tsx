...
export default function KitchenStep() {
  return (
    ...
    >
      ...
      >
        <BookOpen style={{ width: 40, height: 40, color: "var(--wc-pal-accent, #B07D56)" }} />
      </div>
      <div>
        <h2
        ...
        <p className="text-sm leading-relaxed mb-4" style={{ color: "#9A7A5A" }}>
          Save any recipe you find into your collection, or write your own and publish them for others.
          Organise recipes into Cookbooks — one for weeknight dinners, one for special occasions, whatever works for you.
          My Recipes is your permanent, personal archive.
        </p>
      </div>
      <Link
        href="/my-recipes"
