#!/usr/bin/env node
// fix-descriptions-premium.mjs — live streaming progress for premium recipes
import http from "http";

const body = JSON.stringify({ dryRun: false, onlyPremium: true, limit: 200 });

console.log("Fixing descriptions for PREMIUM recipes...");
